...
prep4cases[{data_,noise_},\[Lambda]_,truevals_,sigtols_, restols_,nfunda_, ndelays_, deg_,meff_, noisyQ_]:=
...
zTLS = usvdot@(  (  pickysvd[znoisy, sigtols] )[[1]]);

(* Noise resistant DMD: Noise added to both data matrices --> Inner \
product with the average in front *)
